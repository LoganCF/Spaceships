...
%dmd% -lib -I.. api.d mt.d platform.d network/layer.d network/neuralnetwork.d network/neuron.d network/serialize.d learning/backprop.d activation/sigmoid.d activation/tanh.d cost/mse.d cost/sse.d util.d
