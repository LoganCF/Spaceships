...
%dmd%  -lib -I.. api.d mt.d platform.d network/layer.d network/neuralnetwork.d network/neuron.d network/serialize.d learning/backprop.d learning/backprop_mod_reinforcement.d ^
activation/model/iactivation.d activation/sigmoid.d activation/tanh.d activation/linear.d activation/leaky_relu.d activation/leaky_relu6.d ^
cost/mse.d cost/sse.d util.d
